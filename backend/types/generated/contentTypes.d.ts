...
export interface ApiAlbumAlbum extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Music album with metadata';
    displayName: 'Album';
    pluralName: 'albums';
    singularName: 'album';
  };
...
export interface ApiTrackTrack extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    track_number: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 1;
